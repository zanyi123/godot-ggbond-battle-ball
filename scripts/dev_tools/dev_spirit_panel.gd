...
func _open_skill_edit_panel(skill_id: String) -> void:
	...
	# 右键说明
	var hint := Label.new()
	hint.text = "点击标签切换选中（绿色=已选中），参数已预填默认值可自行修改"
...
func _get_param_default(tag_id: String, param_name: String) -> String:
	...
	var defaults: Dictionary = {
		# === FIELD 类（11个）===
		"field_obs_add": {
			"shape": "rect", "width": "140", "height": "28", "radius": "40",
			"arc_angle": "120", "hp": "300", "attack_consume_rate": "10",
			"speed_consume_rate": "40", "max_count": "2", "duration": "12", "mouse_ops": "1",
		},
		"field_obs_clear": {"clear_count": "2", "mouse_ops": "2"},
		"field_terra_change": {"friction": "1", "bounciness": "0", "duration": "10"},
		"field_terra_revert": {"zone_id": ""},
		"field_zone_mark": {"zone_type": "0", "position": "0,0", "size": "200,200", "duration": "10"},
		"field_zone_clear": {"zone_id": ""},
		"field_zone_boost": {"position": "0,0", "size": "200,200", "boost_multiplier": "1.5", "duration": "10"},
		"field_zone_slow": {"position": "0,0", "size": "200,200", "slow_multiplier": "0.5", "duration": "10"},
		"field_zone_danger": {"position": "0,0", "size": "200,200", "damage_value": "10", "duration": "10"},
		"field_zone_safe": {"position": "0,0", "size": "200,200", "duration": "10"},
		"field_illusion_add": {"illusion_type": "clone", "position": "0,0", "duration": "5"},
		"field_illusion_clear": {"illusion_id": ""},
		# === BALL 类（17个，数值对齐测试平台 _BALL_DEFAULTS）===
		"ball_dmg_up_pct": {"value": "50"},
		"ball_dmg_down_pct": {"value": "50"},
		"ball_dmg_up_flat": {"value": "20"},
		"ball_dmg_down_flat": {"value": "20"},
		"ball_speed_up_pct": {"multiplier": "1.5"},
		"ball_speed_down_pct": {"multiplier": "1.5"},
		"ball_speed_up_flat": {"value": "100"},
		"ball_speed_down_flat": {"value": "100"},
		"ball_tracking": {"turn_speed": "5"},
		"ball_avoid": {},
		"ball_boomerang": {"return_distance": "400"},
		"ball_straight": {},
		"ball_lockon": {},
		"ball_spread": {"split_count": "3"},
		"ball_penetrate": {},
		"ball_range_up": {"radius": "120", "damage_pct": "0.5"},
		"ball_range_down": {"multiplier": "0.5"},
		# === PLAYER 属性类（16个，value/duration）===
		"player_atk_up_pct": {"value": "30", "duration": "5"},
		"player_atk_down_pct": {"value": "30", "duration": "5"},
		"player_atk_up_flat": {"value": "10", "duration": "5"},
		"player_atk_down_flat": {"value": "10", "duration": "5"},
		"player_def_up_pct": {"value": "30", "duration": "5"},
		"player_def_down_pct": {"value": "30", "duration": "5"},
		"player_def_up_flat": {"value": "10", "duration": "5"},
		"player_def_down_flat": {"value": "10", "duration": "5"},
		"player_spd_up_pct": {"value": "30", "duration": "5"},
		"player_spd_down_pct": {"value": "30", "duration": "5"},
		"player_spd_up_flat": {"value": "10", "duration": "5"},
		"player_spd_down_flat": {"value": "10", "duration": "5"},
		"player_res_up_pct": {"value": "30", "duration": "5"},
		"player_res_down_pct": {"value": "30", "duration": "5"},
		"player_res_up_flat": {"value": "10", "duration": "5"},
		"player_res_down_flat": {"value": "10", "duration": "5"},
		# === PLAYER 状态类（包含 target 的填默认目标）===
		"player_invincible": {"duration": "3"},
		"player_vulnerable": {"multiplier": "1.5", "duration": "5"},
		"player_stealth": {"duration": "3"},
		"player_reveal": {"target_id": "", "duration": "3"},
		"player_hp_heal_pct": {"value": "20", "target": "self"},
		"player_hp_damage_pct": {"value": "20", "target": "enemies"},
		"player_hp_heal_flat": {"value": "30", "target": "self"},
		"player_hp_damage_flat": {"value": "30", "target": "enemies"},
		"player_hp_regen": {"value": "5", "duration": "5", "target": "self"},
		...
		"player_energy_gain_flat": {"value": "30", "target": "self"},
		"player_energy_cost_flat": {"value": "30", "target": "enemies"},
		"player_energy_max_up_pct": {"value": "30", "duration": "5"},
		"player_energy_max_down_pct": {"value": "30", "duration": "5"},
		"player_energy_max_up_flat": {"value": "20", "duration": "5"},
		"player_energy_max_down_flat": {"value": "20", "duration": "5"},
		"player_spirit_cost_down": {"multiplier": "0.5", "duration": "5"},
		"player_spirit_cost_up": {"multiplier": "1.5", "duration": "5"},
		"player_spirit_uses_up": {"skill_id": "", "bonus_uses": "1", "duration": "5"},
		"player_spirit_cd_down": {"multiplier": "0.5", "duration": "5"},
		"player_spirit_cd_up": {"multiplier": "1.5", "duration": "5"},
		"player_spirit_double": {"skill_id": "", "duration": "5"},
		"player_spirit_half": {"skill_id": "", "duration": "5"},
		"player_stun": {"duration": "2"},
		"player_cc_immune": {"duration": "3"},
		"player_silence": {"duration": "3"},
		"player_disarm": {"duration": "3"},
		"player_teleport": {"target_position": "0,0"},
		"player_return": {"player_id": ""},
	}
